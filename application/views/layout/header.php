...
<head>
  ...
  <title>Rentakā | Halaman Admin</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/users/index')?>" class="nav-link">User</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/mobil/index')?>" class="nav-link">Mobil</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/merk/index')?>" class="nav-link">Merk</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/perawatan/index')?>" class="nav-link">Perawatan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/sewa/index')?>" class="nav-link">Penyewaan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('index.php/home/index')?>" class="h1 ml-4 mb-4"><img class="logo" src="<?php echo base_url('rentaka.png')?>" alt="" width="100px"></a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Rental Mobil - Rentakā</h1>
          </div>
          <div class="col-sm-6">
