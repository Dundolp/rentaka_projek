...
<!-- <div class="card"> -->
 ...
 <thead>
 <tr>
 <th>ID</th><th>Tanggal</th><th>Biaya</th><th>KM Mobil</th><th>Deskripsi</th>
<th>Id Mobil</th><th>Id Jenis Perawatan</th><th>Aksi</th>
 </tr>
 </thead>
 <tbody>
 <?php

 foreach($list_perawatan as $rwt){
 ?>
 <tr>
 ...
 <td><?=$rwt->tanggal?></td>
 <td><?=$rwt->biaya?></td>
 <td><?=$rwt->km_mobil?> KM</td>
 <td><?=$rwt->deskripsi?></td>
<td><?=$rwt->mobil_id?></td>
<td><?=$rwt->jenis_perawatan_id?></td>
<td>
<a href="view?id=<?=$rwt->id?>">view</a> |
<a href="edit?id=<?=$rwt->id?>">edit</a> |
<a href="delete?id=<?=$rwt->id?>"  onclick="if(!confirm('Anda Yakin Hapus Data dengan id <?=$rwt->id?>?')) {return false}">delete</a>
</td>
 </tr>
 <?php
